...
class DatabaseRequest(Provider):
    ...
    def process(self):
        ...
        if (database_type == "postgresql"):
            ...
            getLogger(__name__).info("ip machine : " + self._config.get('machine_addr'))
            getLogger(__name__).info("database name : " + self._config.get('database_name'))
            getLogger(__name__).info("user name : " + self._config.get('user_database'))
